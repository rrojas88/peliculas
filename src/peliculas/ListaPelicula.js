...
class ListaPelicula extends React.Component {
    ...
    consultarPeliculas(  ){
        ...
        let url = 'http://localhost/server/api/peliculas';
    ...
    borrarRegistro( datos ){
        ...
        let url = 'http://localhost/server/api/eliminar-pelicula';
    ...
    render(){
        ...
        function Listar(props)
        {
            ...
            const listado = listadoBD.map(( item ) =>{
                let url_edit = '/form-peliculas/'+item.id
                let this_ = this
